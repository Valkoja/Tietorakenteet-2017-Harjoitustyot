...
Variation_4::Variation_4() : Variation_0()
{
    // Parentin rakentaja
}

void Variation_4::runSimulation()
{
    ...
    while (currentTime < timeLimit)
    {
        ...
        runway3.setStatus(Runway_activity::idle);
        ...
        // Kolmas kiitorata koittaa tyhjentää jonoja
        processQueue(runway3, landingQueue, Runway_activity::landing);
        processQueue(runway3, takeoffQueue, Runway_activity::takeoff);

        // Kentällä tyhjää
        if (runway1.getStatus() == Runway_activity::idle && runway2.getStatus() == Runway_activity::idle && runway3.getStatus() == Runway_activity::idle)
        {
            idleTime++;
